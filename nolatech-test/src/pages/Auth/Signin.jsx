...
export default function SignIn() {
    ...
    return (
        <>
            <Toaster/>
            <div className="flex flex-col p-4 rounded-md shadow-lg bg-white gap-4 relative">
                <div
                ...
                <div
                    className={classNames("bg-gray-500/40 absolute w-full h-full top-0 left-0 rounded-md flex justify-center", {
                        hidden: !loading
                    })}>
                    <AiOutlineLoading className={"m-auto animate-spin"} size={48}/>
                </div>
            </div>
        </>
    );
